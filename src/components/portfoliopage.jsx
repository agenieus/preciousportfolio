      ...
      <header className="sticky top-0 z-40 bg-white/60 backdrop-blur-md border-b border-white/60">
        <div className="max-w-6xl mx-auto px-6 py-4 flex items-center justify-between">
          ...
          <nav className="hidden md:flex items-center gap-6">
            ...
            <a href="#contact" className="text-sm hover:text-purple-600">Contact</a>
      ...
      <main className="max-w-6xl mx-auto px-6">
        ...
        <section className="grid lg:grid-cols-2 gap-8 items-center py-12">
          <motion.div initial="hidden" animate="show" variants={reduce ? {} : fadeUp(0.1)}>
            <p className="text-sm text-purple-600 font-medium">Hello, I'm Precious</p>
            ...
            <p className="mt-4 text-gray-600 max-w-xl">Passionate about creating user-friendly interfaces; turning complex ideas into simple solutions.</p>

            <div className="mt-6 flex gap-3">
              <a href="#contact" className="inline-flex items-center rounded-full bg-gradient-to-r from-purple-600 to-pink-500 text-white px-5 py-3 text-sm font-semibold shadow-lg">Hire me</a>
              <a href="#portfolio" className="inline-flex items-center rounded-full border border-purple-200 px-4 py-3 text-sm font-medium">View work</a>
            </div>
          </motion.div>
          ...
          <motion.div className="flex justify-center lg:justify-end" initial={{ opacity: 0, x: 30 }} animate={{ opacity: 1, x: 0, transition: { duration: 0.8 } }}>
            {/* Use a cutout profile image – put your image in public/assets/hero.png */}
            <img src="/assets/hero.png" alt="Precious smiling" className="w-64 md:w-80 lg:w-96 object-contain drop-shadow-2xl -mb-6" />
          </motion.div>
        </section>
        ...
        <section id="about" className="py-8">
          <motion.div initial="hidden" whileInView="show" viewport={{ once: true }} variants={reduce ? {} : fadeUp(0.15)}>
            <div className="bg-white/60 rounded-2xl p-6 md:p-10 shadow-inner border border-white/40">
              <h3 className="text-lg font-semibold">About Me</h3>
              <p className="mt-3 text-gray-600">I am a UI/UX designer who loves turning ideas into smooth intuitive experiences. I enjoy simplifying complex problems through design, making products easy to use.</p>
              <div className="mt-4">
                <a href="#contact" className="inline-flex items-center rounded-full bg-purple-100 text-purple-700 px-4 py-2 text-sm font-medium">Hire me</a>
              </div>
            </div>
          </motion.div>
        </section>
        ...
        <section id="workflow" className="py-8">
          <motion.h2 initial={{ opacity: 0, y: 12 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="text-center text-lg font-semibold">My Workflow</motion.h2>
        ...
        <section id="portfolio" className="py-8">
          <div className="grid md:grid-cols-2 gap-8 items-center">
            <motion.div initial="hidden" whileInView="show" viewport={{ once: true }} variants={reduce ? {} : fadeUp(0.18)}>
              <h3 className="text-2xl font-bold">UI/UX<br/>Designs</h3>
              ...
              <div className="mt-6">
                <a href="#portfolio" className="inline-flex items-center rounded-full bg-purple-50 border border-purple-200 text-purple-700 px-4 py-2 text-sm font-medium">View My Work</a>
              </div>
            </motion.div>
        ...
        <section id="contact" className="py-10">
          <div className="max-w-xl mx-auto bg-white/60 rounded-2xl p-6 md:p-10 shadow-lg border border-white/40">
            ...
            <form className="mt-6 grid gap-4" onSubmit={(e) => { e.preventDefault(); alert('Thanks — message sent! (demo)'); }}>
              <label className="sr-only" htmlFor="name">Name</label>
              <input id="name" name="name" placeholder="Name" className="px-4 py-3 rounded-lg border border-transparent bg-purple-50 focus:outline-none focus:ring-2 focus:ring-purple-200" />

              <label className="sr-only" htmlFor="email">Email</label>
              <input id="email" type="email" name="email" placeholder="Email" className="px-4 py-3 rounded-lg border border-transparent bg-purple-50 focus:outline-none focus:ring-2 focus:ring-purple-200" />

              <label className="sr-only" htmlFor="message">Message</label>
              <textarea id="message" name="message" rows="5" placeholder="Message" className="px-4 py-3 rounded-lg border border-transparent bg-purple-50 focus:outline-none focus:ring-2 focus:ring-purple-200"></textarea>

              <div className="text-right">
                <button type="submit" className="inline-flex items-center rounded-full bg-gradient-to-r from-purple-600 to-pink-500 text-white px-6 py-3 text-sm font-medium shadow">Send</button>
              </div>
            </form>
          </div>
        </section>
